...
(
    ...
    CONSTRAINT check_addresses_street_number_is_positive
        CHECK ("street_number" > 0),

    CONSTRAINT check_addresses_zip_code_is_positive
        CHECK ("zip_code" > 0)
);
...
(
    ...
    CONSTRAINT check_players_ranges_min_players_is_positive
        CHECK ("min_players" > 0),

    CONSTRAINT check_players_ranges_max_players_is_positive
        CHECK ("max_players" > 0)
);
...
(
    ...
    CONSTRAINT check_board_games_release_year_is_positive
