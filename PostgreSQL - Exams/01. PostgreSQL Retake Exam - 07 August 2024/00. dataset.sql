...
INSERT INTO "productions_info" ("rating", "duration", "budget", "release_date", "has_subtitles", "synopsis")
VALUES (7.50, 120, 5500000.00, '2023-01-01', true, 'A gripping action-packed adventure about a secret agent.'),
       (8.20, 150, 1000000.00, '2022-12-25', false,
        'A heartwarming drama exploring the complexities of family relationships.'),
       ...
       (8.50, 140, 9500000.00, '2021-09-22', false,
        'A musical journey that celebrates the power of music and friendship.'),
       (7.30, 105, 3500000.00, '2022-04-01', true,
        'A fantasy tale of a young hero on a quest to save a magical kingdom.'),
       (8.00, 125, 6000000.00, '2023-03-30', false, 'A documentary that delves into the lives of endangered species.'),
       (6.50, 90, 150000.00, '2021-06-18', true,
        'A comedy about a group of friends navigating the ups and downs of life.'),
       (7.80, 115, 45000000.00, '2022-10-31', false,
        'A horror film that explores the dark secrets of a haunted house.'),
       (7.90, 100, 500000.00, '2021-08-12', true,
        'A sci-fi adventure set in a dystopian future where humanity fights for survival.'),
       (8.30, 135, 120000.00, '2023-02-14', false,
        'A romantic tale of two souls destined to be together against all odds.'),
       (6.90, 105, 30000.00, '2022-11-20', true,
        'An animated story about a group of animals embarking on an epic journey.'),
       (7.60, 130, 80000.00, '2023-05-05', false,
        'A biography chronicling the life and achievements of a renowned scientist.'),
       ...
       (8.40, 140, 1050000.00, '2021-09-30', false,
        'A thriller that takes the audience on a rollercoaster of suspense.'),
       (6.70, 100, 2500000.00, '2022-07-07', true, 'A musical comedy that brings laughter and joy to the audience.'),
       (7.20, 125, 5500000.00, '2023-01-20', false,
        'A documentary exploring the cultural heritage of an ancient civilization.'),
       (3.50, 11, NULL, '2024-05-15', false, NULL),
       (7.99, 13, NULL, '2021-07-04', true, NULL);

INSERT INTO "productions" ("title", "country_id", "production_info_id")
VALUES ('Lumiere and Company', 21, 1),
       ('Ask the Dust', 3, 2),
       ('Vikings', 2, 3),
...
INSERT INTO "productions_actors" ("production_id", "actor_id")
VALUES (1, 15),
       (2, 28),
       (3, 56),
       (4, 132),
...
INSERT INTO "categories_productions" ("category_id", "production_id")
VALUES (6, 1),
       (21, 2),
       (20, 3),
       (8, 4),
